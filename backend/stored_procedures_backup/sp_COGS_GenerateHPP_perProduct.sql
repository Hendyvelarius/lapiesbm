...
begin
	delete t_COGS_HPP_Product_Header where Periode=@Periode and Product_ID=@_product_id
	delete t_COGS_HPP_Product_Detail_Formula where Periode=@Periode and Product_ID=@_product_id
end
...
into #tmp_utk_granul
from #tmp a join m_product b on a.product_id=b.product_id
where Product_Name like '%granulat%'
...
dbo.fnConvertBJOpponent(PPI_ItemID,1,'g',PPI_UnitID) * b.hpp,
total=PPI_QTY*b.HPP*dbo.fnConvertBJOpponent(PPI_ItemID,1,'g',PPI_UnitID) 
