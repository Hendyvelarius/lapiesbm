...
--exec [sp_generate_simulasi_cogs_price_update] 'D 018:3400','2026'
--begin tran
--select * from 
CREATE procedure [dbo].[sp_generate_simulasi_cogs_price_update] 
...
into #tmp_list_material_changes
 from 
	...
	join vw_COGS_Currency_List d on d.Curr_Code=b.ITEM_CURRENCY and d.Periode = b.periode
	where b.Periode= @periode --year(GETDATE())
...
from	t_COGS_HPP_Product_Header a join 
	...
	on a.Product_ID = b.Product_ID and a.Periode=b.Periode
...
--select * from t_COGS_HPP_Product_Header_Simulasi order by simulasi_id desc
--declare @ringkasan_perubahan as nvarchar(4000) = 'Price Update : AC 209A: 0.00187 -> 50.4; '
...
where a.Simulasi_Deskripsi='Price Update : ' + @ringkasan_perubahan and a.Simulasi_Date=@simulasi_date
...
--2025-09-23 20:55:48.837 Price Update : AC 209A: 0.00187 -> 50.4; 
