-- =====================================================================
-- Stored Procedure: sp_COGS_Calculate_HPP_Actual (v3)
...
BEGIN
    ...
    BEGIN
        BEGIN TRY
            ...
            -- Formula detail from t_COGS_HPP_Product_Detail_Formula
            LEFT JOIN t_COGS_HPP_Product_Detail_Formula f 
                ON f.Product_ID = @CurrentProductID 
               AND f.PPI_ItemID = d.MR_ItemID
               AND f.Periode IN (@GroupPeriode, CAST(CAST(@GroupPeriode AS INT) - 1 AS VARCHAR))
