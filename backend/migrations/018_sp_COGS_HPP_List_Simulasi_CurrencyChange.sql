-- =====================================================================
-- Stored Procedure: sp_COGS_HPP_List_Simulasi_CurrencyChange
-- Purpose: Return before/after HPP comparison for a Currency Changes
--          simulation group, identified by description + Simulasi_Date.
--          Mirrors sp_COGS_HPP_List_Simulasi_PriceChange but filters on
--          Simulasi_Type = 'Currency Changes'.
-- =====================================================================

IF OBJECT_ID('dbo.sp_COGS_HPP_List_Simulasi_CurrencyChange', 'P') IS NOT NULL
    DROP PROCEDURE dbo.sp_COGS_HPP_List_Simulasi_CurrencyChange;
GO
