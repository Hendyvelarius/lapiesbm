-- =====================================================================
-- Stored Procedure: sp_COGS_Calculate_HPP_Actual (v9)
-- Purpose: Calculate true batch cost based on actual material prices
-- Changes in v9:
--   - ARCHITECTURAL CHANGE: Granulates as first-class products
--     Previously, granulate costs were calculated inline and stored only
--     as columns on the product detail (Granulate_Batch, Granulate_Raw_Cost etc.)
--     This made validation difficult and didn't support future manhour calculations.
--     
--     NEW APPROACH:
...
BEGIN
    ...
    PRINT '';
    PRINT '========================================';
    PRINT 'HPP Actual Calculation Summary (v9)';
    PRINT '========================================';
...
PRINT 'Stored procedure sp_COGS_Calculate_HPP_Actual v9 created successfully';
GO
